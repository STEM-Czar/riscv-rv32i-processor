...
module mux21_dataflow_tb;

    reg inA; reg inB; reg S; wire OUT;

    mux21_dataflow MUX21 (.mux21_out(OUT), .mux21_inA(inA), .mux21_inB(inB), .mux21_S(S));

    initial begin

        $dumpfile("mux21_dataflow_wave.vcd");
        $dumpvars(0, mux21_dataflow_tb);
