...
module mux21_conditional_tb;

    reg inA; reg inB; reg S; wire OUT;

    mux21_conditional MUX21 (.mux21_out(OUT), .mux21_inA(inA), .mux21_inB(inB), .mux21_S(S));

    initial begin

        $dumpfile("mux21_conditional_wave.vcd");
        $dumpvars(0, mux21_conditional_tb);
